...
const Header = () => {
    ...
    const navaclickHandler = () => {

        setNavisClicked(navisClicked ? false : true);
        console.log(navisClicked, 'state')
    }
    ...
    return (
        <MainNav>
            <nav className={classes.header} >
                <div className={classes.logo} onClick={navaclickHandler} href='/home'>
                    <a href="/home">
                ...
                <ul className={classes.links} onClick={navaclickHandler}>
                    ...
                    <li>
                        <NavLink to='/men' activeClassName={classes.active}>Men</NavLink>
                    </li>
                    <li>
                ...
                <HeaderControl serachHanlder={navisClicked} />
            </nav>
