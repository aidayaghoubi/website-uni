                    ...
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="21.869" height="23.491" viewBox="0 0 21.869 23.491">
                            <g id="shop" transform="translate(0.401 0.4)">
                                <path id="Path_15" data-name="Path 15" d="M30.6,56.064H13.551a2.008,2.008,0,0,1-2-2.14l.793-12.048a2.013,2.013,0,0,1,2-1.876H29.809a2.013,2.013,0,0,1,2,1.876l.793,12.048a2.008,2.008,0,0,1-2,2.14ZM14.344,40.8a1.208,1.208,0,0,0-1.2,1.126l-.793,12.048a1.2,1.2,0,0,0,1.2,1.284H30.6a1.2,1.2,0,0,0,1.2-1.284l-.793-12.048a1.208,1.208,0,0,0-1.2-1.126Z" 
                                transform="translate(-11.543 -33.373)" fill="#979797" stroke="#979797" strokeWidth="0.8" />
                                <path id="Path_16" data-name="Path 16" d="M42.655,16.839a.4.4,0,0,1-.4-.4v-.9c0-4.263-2.792-7.731-6.225-7.731S29.8,11.271,29.8,15.534v.9a.4.4,0,0,1-.8,0v-.9C29,10.828,32.153,7,36.028,7s7.028,3.828,7.028,8.534v.9A.4.4,0,0,1,42.655,16.839Z" transform="translate(-25.495 -7)" fill="#979797" stroke="#979797" strokeWidth="0.8" />
                            </g>
                        </svg>
                    </span>
                </button>
